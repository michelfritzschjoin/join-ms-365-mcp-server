...
- fix generated client: get-chat endpoint (unterminated template literal, correct response schema)

## [1.22.2](https://github.com/michelfritzschjoin/join-ms-365-mcp-server/compare/v1.22.1...v1.22.2) (2026-02-02)
...
- **discover-company:** implement balanced aggregation and keyfindings extraction ([617a762](https://github.com/michelfritzschjoin/join-ms-365-mcp-server/commit/617a76289136a3a0a5682b370388fb4e37e80474))
...
- **super-tools:** integrate nlp and dataaggregator in discovery functions ([a6efdd0](https://github.com/michelfritzschjoin/join-ms-365-mcp-server/commit/a6efdd07c0eef7d85ca1b1d4b4da16543a4d25a1))

## [1.11.0](https://github.com/michelfritzschjoin/join-ms-365-mcp-server/compare/v1.10.1...v1.11.0) (2026-01-28)
...
- **search:** integrate nlp for intelligent calendar query detection and better suggestions ([ed4b9c8](https://github.com/michelfritzschjoin/join-ms-365-mcp-server/commit/ed4b9c880ece01f53e878e9fad5f37b3801273f7))

## [1.10.0](https://github.com/michelfritzschjoin/join-ms-365-mcp-server/compare/v1.9.1...v1.10.0) (2026-01-28)
...
- include full chat message content in Teams responses ([ac313c6](https://github.com/michelfritzschjoin/join-ms-365-mcp-server/commit/ac313c6d338ef95b545dc19004196a9e3b3aec55))

## [1.8.0](https://github.com/michelfritzschjoin/join-ms-365-mcp-server/compare/v1.7.1...v1.8.0) (2026-01-27)
